...
const AuthModal = ({ authModalOpen, setAuthModalOpen, slug = null }) => {
  ...
  // useEffect(() => {
  //   handleFormValue("User");
  // }, []);
  // const handleFormValue = (role) => {
  //   switch (role) {
  //     case "Admin":
            ...
            items={[
              {
                ...
                children: (
                  <>
                    {/* button for code canyone  */}
                    {/* <div>
                      <div className="mt-4 flex justify-center space-x-2 xl:space-x-10 font-poppins text-[16px] font-medium text-[#333]">
                        <button
                          onClick={() => {
                            setSelectedRole("User");
                            handleFormValue("User");
                          }}
                          className={`relative flex gap-2 items-center lg:text-base text-sm px-2 rounded-[6px]  hover:border-primary ${selectedRole === "User"
                        ...
                        <button
                          onClick={() => {
                            ...
                            handleFormValue("Employee");
                          }}
                          className={`relative flex gap-2 items-center lg:text-base text-sm px-2 rounded-[6px]  hover:border-primary ${selectedRole === "Employee"
                            ? "border-b-[2px] border-primary"
                            : "text-textColor"
                            }`}
                        >
                        ...
                        <button
                          onClick={() => {
                            ...
                            handleFormValue("Admin");
                          }}
                          className={`relative flex gap-2 items-center lg:text-base text-sm px-2 rounded-[6px]  hover:border-primary ${selectedRole === "Admin"
                            ? "border-b-[2px] border-primary "
                            : "text-textColor"
                            }`}
                        >
